...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    public void getWeather(Periods periods) throws IOException {
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            System.out.println("В городе " + ApplicationGlobalState.getInstance().getSelectedCity() + " " + weather.getWeatherText() + ", температура "
                    + weather.getTemperature().getMetric().getValue() + " градусов по Цельсию");
